...
def diff_analyzer_argument_parser(description: str, module_path: str) -> argparse.ArgumentParser:
    parser = create_parser(description, module_path)
    parser.add_argument("--output-directory", "-od", dest="output_directory", default="clang-format",
                        help="Directory to store fixed files, generated by clang-format "
                             "and HTML files with diff; the default value is 'clang-format'. "
