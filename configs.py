...
configs = Variations([dict(name="Update Docker images", command=["make", "images"]),
                      dict(name="Update Pylint", command=[f"python{python_version}", "-m", "pip", "install",
                      ...
                      dict(name="Run static pylint", code_report=True,
                           command=[f"python{python_version}", "-m", "universum.analyzers.pylint",
                      ...
                      dict(name="Run static type checker", code_report=True,
                           command=[f"python{python_version}", "-m", "mypy", "universum/", "--ignore-missing-imports"]),
