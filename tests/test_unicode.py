...
def test_unicode(vcs, test_type, perforce_workspace, git_client, unicode_dir):
    if vcs == "git":
        ...
        env = git_utils.GitTestEnvironment(git_client, unicode_dir, test_type=test_type)
    elif vcs == "p4":
        ...
        env = perforce_utils.P4TestEnvironment(perforce_workspace, unicode_dir, test_type=test_type)
    else:
